...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`lc` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `lc`;

/*Table structure for table `lc_container` */
...
/*Table structure for table `lc_container_event` */
...
/*Table structure for table `lc_container_event_change_log` */
...
CREATE TABLE `lc_container_event_change_log` (
  ...
  `source` varchar(4096) NOT NULL DEFAULT '' COMMENT '源信息',
  `target` varchar(4096) NOT NULL DEFAULT '' COMMENT '目标信息',
  `change_time` timestamp NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='箱事件变更日志表';

/*Table structure for table `lc_customs_declaration` */
...
/*Table structure for table `lc_exception` */
...
CREATE TABLE `lc_exception` (
  ...
  `exception_level` tinyint(4) NOT NULL DEFAULT '0' COMMENT '异常等级（0.一般 1.严重）',
  `exception_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '异常类型（加锁/漏装/查验/改装/改配/退关 等等）',
  `location` tinyint(4) NOT NULL DEFAULT '0' COMMENT '地点（岗前服务/堆场/港区/海上/目的港）',
...
/*Table structure for table `lc_lading_bill` */
...
/*Table structure for table `lc_port_call` */
...
/*Table structure for table `lc_scheduled_task` */
...
/*Table structure for table `lc_scheduled_task_log` */
...
/*Table structure for table `lc_shipping_schedule` */
...
/*Table structure for table `lc_shipping_tracking` */
...
/*Table structure for table `lc_subscribe` */
...
/*Table structure for table `lc_subscribe_detail` */
...
/*Table structure for table `lc_supplier_container` */
...
/*Table structure for table `lc_supplier_container_event` */
...
/*Table structure for table `lc_supplier_data` */
...
/*Table structure for table `lc_supplier_shipping_schedule` */
...
/*Table structure for table `lc_supplier_shipping_schedule_event` */
...
/*Table structure for table `lc_supplier_voyage` */
...
/*Table structure for table `lc_trailer_tracking` */
...
/*Table structure for table `lc_voyage` */
...
/*Table structure for table `lc_yard` */
